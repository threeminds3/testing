...
(function(_global) {
	...
	Scene_CompositeMenu.prototype.create = function() {
		...
		this._exeWindow = new Window_RTK_SingleCommand(0, 0, 1, [RTK.text("Exchange")]);
		this._exeWindow.move(Graphics.boxWidth - 145 - this._exeWindow.textPadding() - 20, Graphics.boxHeight - this._exeWindow.height - this._exeWindow.textPadding() - 50, 150, this._exeWindow.height);
